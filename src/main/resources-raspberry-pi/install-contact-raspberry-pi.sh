...
#
#
THIS_SCRIPT_FILE_NAME=install-contact-raspberry-pi.sh
HOME_DIR=/home/andold
SOURCE_DIR=$HOME_DIR/src/github/contact
DEPLOY_DIR=$HOME_DIR/deploy/contact
...
cd	$SOURCE_DIR
git stash
git pull ssh://git@ssh.github.com:443/andold/contact.git
